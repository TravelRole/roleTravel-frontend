    ...
    <Container>
      ...
      <Content>
        ...
        <InputContainer>
          ...
          <Input name="nickname" value={nickname} onChange={changeHandler} placeholder="닉네임" />
        </InputContainer>
        <InputContainer>
          {/* <Label width="80px">생년월일</Label> */}
          <Input maxLength={4} name="year" value={date.year} onChange={changeHandler} placeholder="생년월일"  />
        </InputContainer>
      </Content>
      <Content>
