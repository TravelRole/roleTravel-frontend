    ...
    <SignModalWrap>
      ...
      <div className="sign-text">
        ...
        <dl>
          <dt>제1조 (목적)</dt>
          <dd>
            이 약관은 여행역할 ( 이하 ‘ 회사 ’ 라고 합니다 ) 가 제공하는 제반
            서비스의 이용과 관련하여 회사와 회원과의 관리, 의무 및 책임사항,
            기타 필요한 사항을 규정함을 목적으로 합니다.
          </dd>
        </dl>
        <dl>
          <dt>제2조 (정의)</dt>
          <dd>이 약관에서 사용하는 주요 용어의 정의는 다음과 같습니다.</dd>
          <dd>
          ...
          <dd>
            4. ‘기업회원’ 은 회사에 기업정보 및 개인정보를 제공하여 회원등록을
            한 사람으로, 회사로부터 지속적으로 정보를 제공받고 회사가 제공하는
        ...
        <dl>
          ...
          <dd>
            ...
            서비스의 개별약관, 운영정책 및 규칙 등(이하 세부지침)의 규정에 따라
            다릅니다. 또한 본 약관과 세부지침이 충돌할 경우에는 세부지침에
            따릅니다.
          </dd>
        </dl>
        <dl>
          <dt>제4조 (약관의 효력과 변경)</dt>
          <dd>
            1. 이 약관은 여행역할(이)가 제공하는 모든 인터넷서비스에 게시하여
            ...
            문자메시지, 서비스 내 전자쪽지발송, 알림 메시지를 띄우는 방법)으로
            개별 통지합니다. 변경된 약관은 공지하거나 통지한 시행일로부터 효력이
            발생합니다.
          </dd>
          <dd>
            2. 회사가 제1항에 따라 개정약관을 공지 또는 통지하는 경우 ‘변경에
            동의하지 아니한 경우 공지일 또는 통지를 받은 날로부터 7이
            (이용자에게 불리하거나 중대한 사항의 변경인 경우에는 30일) 내에
            계약을 해지할 수 있으며, 계약해지의 의사표시를 하지 아니한 경우에는
        ...
        <dl>
          ...
          <dd>
            ...
            관련된 사항의 저장 등 부가서비스를 이용하면서 위1호 및 2호의 절차를
            진행한 때
          </dd>
        </dl>
        <dl>
          <dt>제7조 (회원가입에 대한 승낙)</dt>
          <dd>
          ...
          <dd>
            4. 이용약관에 따라 서비스 이용을 승낙하지 아니하거나 유보한 경우,
        ...
        <dl>
          ...
          <dd>
            ...
            생기거나 멸실된 때에는 이를 지체없이 수리 또는 복구하며, 다음 각
            호의 사유 발생 시 부득이한 경우 예고 없이 서비스의 전부 또는 일부의
            제공을 일시 중지할 수 있습니다. 이 경우 그 사유 및 중지 기간 등을
            이용자에게 지체없이 사후 공지합니다.
            <br />
            가. 시스템의 긴급점검, 중설, 교제, 시설의 보수 또는 공사를 하기
            위하여 필요한 경우
            <br />
            나. 새로운 서비스를 제공하기 위하여 시스템교제가 필요하다고 판단되는
            경우
            <br />
        ...
        <dl>
          ...
          <dd>
            2. 회사는 최종 사용일로부터 연속하여 1년동안 서비스 사용 이력이 없는
            경우 ‘개인정보보호법’ 및 같은 법시행령의 규정에 따라 이용자정보를
            영구적으로 삭제할 수 있습니다. 단, 유료결제 상품을 보유하고 있는
            경우 삭제 대상에서 제외되며 관련 법령의 규정에 의하여 보존할 필요가
            있는 경우 회사는 관계법령에서 정한 기간 동안 이용자 정보를
            보관합니다.
          </dd>
          <dd>
            3. 회사가 이용자의 개인정보 보호 및 사용에 대해서 관련 법규 및
        ...
        <dl>
          ...
          <dd>
            ...
            위반하는 경우 서비스 이용제한, 민형사항의 책임 등 불이익이 발생할 수
            있습니다.
          </dd>
        </dl>
        <dl>
          ...
          <dd>
            ...
            <br />
            가. 웹 사이트를 통해 서비스를 이용하실 수 있으며, 이용 약관에
            동의하지 않을 시 서비스의 제공이 불가합니다.
            <br />
            나. 팀 스페이스를 새로 만든 사함은 총무가 되며, 팀 스페이스에 지인
            초대, 초대한 사람의 역할 설정, 모든 페이지의 수정 권한을 갖게 되고
            총무의 탈퇴시 팀 스페이스에 있는 이에게 권한을 위임해야 합니다.
            <br />
            다. 팀 스페이스에 초대받은 인원은 입장 시 역할을 선택할 수 있으며,
            각 역할에 할당된 페이지와 모든 여행 계획 페이지만 수정할 수 있는
            권한을 가집니다.
            <br />
            라. 해당 웹 사이트는 필수적으로 회원가입을 해야 이용이 가능합니다.
          </dd>
        </dl>
        <dl>
          <dt>제14조 (서비스의 제한 등)</dt>
          <dd>
          ...
          <dd>
            3. 회사는 서비스의 이용을 제한하거나 정지하는 때에는 그 사유 및 제한
            기간, 예정 일시 등을 지체없이 이용자에게 알립니다.
          </dd>
          <dd>
        ...
        <dl>
          <dt>제15조 (서비스의 해제·해지 및 탈퇴 절차)</dt>
          <dd>
            1. 이용자가 이용계약을 해지하고자 할 때는 언제든지 홈페이지 상의
          ...
          <dd>
            ...
            이러한 행위를 금지허간 삭제를 요청하였음에도 불구하고 최초의 금지
        ...
        <dl>
          ...
          <dd>
            ...
            정보 보호정책, 기타 서비스별 이용 약관에서 정하는 내용에 위반하지
        ...
        <dl>
          ...
          <dd>
            ...
            등 관련 법에 위반되는 내용을 포함하는 경우, 관리자는 관련 법이 정한
            절차에 따라 해당 콘텐츠의 게시중단 및 삭제 등을 요청할 수 있으며,
            회사는 관련 법에 따라 조치를 취하여야 합니다.
          </dd>
          <dd>
            2. 회사는 전항에 따른 관리자의 요청이 없는 경우라도 권리침해가
